<nav class="modules">
    ...
    <div class="module purple">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=controle&file=relacionais">
            ...
            <li><a href="exercicio.php?dir=controle&file=desafio_operadores_logicos">
    ...
    <div class="module yellow">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=includes&file=include_require">
            Include Vs Require
            </a></li>
            <li><a href="exercicio.php?dir=includes&file=include_retorno">
            Include com Retorno
            </a></li>
            <li><a href="exercicio.php?dir=includes&file=include_once">
            Include Once
            </a></li>
            <li><a href="exercicio.php?dir=includes&file=desafio_include">
            Desafio Include
            </a></li>
        </ul>
    </div>
    ...
    <div class="module purple">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=db&file=consultar_pdo">
            PDO: Consultar
            </a></li>
